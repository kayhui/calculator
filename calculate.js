function go() {
    first = '<div class="container-fluid"><div class="row"><p id="radio" class="fs-2 " style="flex: end 0;"></p></div>';
    first += '<div class="row"><div id="displayZone" class="col-4"><div class="container-fluid firstAlgorite"><div class="row"><div class="col-3 p-0"><input class="form-control h-100" type="text" value="A4(EN)"readonly></div>';
    first += '<div class="col-6 p-0"><div class="form-floating h-100"><input type="number" class="form-control h-100 inputNumA4En" id="floatingInput" placeholder=""><label for="floatingInput">Input pages</label></div></div></div></div></div>';
    ...
    first += '<div class="row"><div id="displayZone" class="col-4"><div id="A4TC" class="container-fluid firstAlgorite"><div class="row"><div class="col-3 p-0"><input class="form-control h-100" type="text" value="A3(EN)"  readonly></div><div class="col-6 p-0"><div class="form-floating h-100"><input type="number" class="form-control h-100 inputNumA3En" id="floatingInput" placeholder=""><label for="floatingInput">Input pages</label></div></div></div></div></div></div>';
    first += '<div class="row"><div id="displayZone" class="col-4"><div id="A3EN" class="container-fluid firstAlgorite"><div class="row"><div class="col-3 p-0"><input class="form-control h-100" type="text" value="A4(TC/SC)" readonly></div><div class="col-6 p-0"><div class="form-floating h-100"><input type="number" class="form-control h-100 inputNumA4Tc" id="floatingInput" placeholder=""><label for="floatingInput">Input pages</label></div></div></div></div></div></div>';
    first += '<div class="row"><div id="displayZone" class="col-4"><div id="A3TC" class="container-fluid firstAlgorite"><div class="row"><div class="col-3 p-0"><input class="form-control h-100" type="text" value="A3(TC/SC)" readonly></div><div class="col-6 p-0"><div class="form-floating h-100"><input type="number" class="form-control h-100 inputNumA3Tc" id="floatingInput" placeholder=""><label for="floatingInput">Input pages</label> </div> </div>  </div> </div> </div></div>';
